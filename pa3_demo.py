...
def load_obj_each_frame(data_file: str) -> dict:
  """Loads a json file containing object track at each frame

  Args:
      data_file (str): filename

  Returns:
      dict: dictionary of object locations
  """
...
def draw_target_object_center(video_file: str, obj_centers: dict):
  ...
  Args:
      video_file (str): original input image file
      obj_centers (dict): object centers over all frames
  """
  count = 0
